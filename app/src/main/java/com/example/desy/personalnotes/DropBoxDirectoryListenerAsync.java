...
public class DropBoxDirectoryListenerAsync extends AsyncTask<Void, Long, Boolean> {
    ...
    public DropBoxDirectoryListenerAsync(Context applicationContext, DropboxAPI<AndroidAuthSession> api, String currentPath, DropBoxPickerActivity dropBoxPickerActivity) {
    }

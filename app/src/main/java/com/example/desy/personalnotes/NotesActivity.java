...
//        int hasCameraPermission = ContextCompat.checkSelfPermission(NotesActivity.this, android.Manifest.permission.CAMERA);
//        if (hasCameraPermission != PackageManager.PERMISSION_GRANTED) {
//            if (!ActivityCompat.shouldShowRequestPermissionRationale(NotesActivity.this,
//                    android.Manifest.permission.READ_CONTACTS)) {
//                ActivityCompat.requestPermissions(NotesActivity.this, new String[] {android.Manifest.permission.CAMERA},
...
//        }
//
//        int hasReadPhotoPermission = ContextCompat.checkSelfPermission(NotesActivity.this, android.Manifest.permission.READ_EXTERNAL_STORAGE);
//        if (hasReadPhotoPermission != PackageManager.PERMISSION_GRANTED) {
//            if (!ActivityCompat.shouldShowRequestPermissionRationale(NotesActivity.this,
...
//        }
//
//        ActivityCompat.requestPermissions(NotesActivity.this, new String[] {android.Manifest.permission.READ_CONTACTS}, REQUEST_CODE_ASK_PERMISSIONS);
//        ActivityCompat.requestPermissions(NotesActivity.this, new String[] {android.Manifest.permission.READ_EXTERNAL_STORAGE}, REQUEST_CODE_ASK_PERMISSIONS);
//    }
}

...
public class AppConstant {
    ...
    // Drop box
    public static final String APP_KEY = "fyeg4c0r8l5ce43";//change this with drop box key
    public static final String APP_SECRET = "8xf9xs7mnk0t87j";//change this with drop box secret key
